...
// B3: Theme toggle — inject the light/dark-navy/dark button into the nav and wire up cycling.
(function(){
  function injectToggle(){
    var backLink = document.querySelector('.nav-inner .back-link');
    if(!backLink || document.getElementById('theme-toggle')) return;
    ...
    btn.innerHTML =
      ...
      '</svg>';
    backLink.insertAdjacentElement('afterend', btn);
    ...
    function setTitle(){ btn.title = TITLES[current()]; }
    setTitle();
